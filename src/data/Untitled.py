...
# %% [markdown]
# Checking the distribution of the classes on Division category

# %% [markdown]
# Checking the distribution of the classes on Group category

# %% [markdown]
# Checking the distribution of the classes on Class category

# %% [markdown]
# Checking the distribution of the classes on Subclass category
