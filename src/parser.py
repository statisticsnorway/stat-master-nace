...
def parse_args():   
    ...
    argparser.add_argument("-cfh", "--checkpoint_file_hier", type=str, default=f"{RES_LM}checkpoint_hier.json")
    argparser.add_argument("-cff", "--checkpoint_file_flat", type=str, default=f"{RES_LM}checkpoint_flat.json")
    argparser.add_argument("-M", "--model_name", type=str, default=MODEL, choices=["meta-llama/Llama-3.1-8B-Instruct",
